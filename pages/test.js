...
export default function Home() {
    ...
    return (
        <Layout>
            ...
            <div 
                id="content-wrapper" 
                className="h-full flex-col flex content-stretch items-center"
            >
                ...
                <div id="content" className="flex flex-col md:w-1/2 items-center">
                    <div>
                        <div id="intro-text">
                            <p className="font-['Courier'] text-4xl md:text-5xl text-blue-500">{"> Hello World."}</p>
                            <p className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-bl from-blue-400 to-red-500">{"I'm Daniel Kobko"}</p>
                        </div>
